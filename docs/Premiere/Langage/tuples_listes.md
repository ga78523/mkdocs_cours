...
Écrivez une fonction `convertir_base(nombre)` qui convertit un nombre entier positif de la base 10 vers la base 2.

**Spécifications :**

* La fonction prend deux paramètres :
    *`nombre` : un entier positif en base 10
    * `base` : la base de destination (un entier entre 2 et 16)
* Elle retourne une liste contenant les chiffres du nombre converti, du plus significatif au moins significatif

**Exemples :**
```python
convertir_base(13)   # retourne [1, 1, 0, 1]  (13 = 1101 en binaire)
```

**Contraintes :**

- `nombre >= 0`
- Ne pas utiliser les fonctions Python intégrées comme `bin()`, `oct()`, `hex()`
