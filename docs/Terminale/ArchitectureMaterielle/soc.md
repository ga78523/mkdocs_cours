...
* Efficacité énergétique : Les SoC ARM sont généralement plus économes en énergie, ce qui les rend idéaux pour les appareils mobiles et les systèmes embarqués. Les SoC x86, en revanche, consomment plus d'énergie mais offrent des performances brutes plus élevées.
...
Le SoC M4 est fabriqué avec le procédé 3 nm de TSMC et contient 28 milliards de transistors.
...
* On trouve le système suivant de SoC sur des nano-ordinateurs comme le Rasberry Pi
