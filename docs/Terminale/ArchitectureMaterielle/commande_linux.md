...
Un utilisateur ne peut pas faire ce qu’il veut. Par contre, le super utilisteur root peut tout faire.

L’affichage détaillé d’un fichier (`ls -lah`) montre :

* les permissions de l’utilisateur courant (u)
* de son groupe (g);
* de tout le monde (o).
...
On change les permissions avec `chmod` soit en ajoutant ou retirant un flag : `$ chmod go+x inside.log` rendra ce fichier exécutable pour le groupe et les autres. 

**Remarque :** + est utilisé pour ajouter des droits et - pour en retirer.

On peut auusi en décrire la permission par 3 chiffres :
...
[Distrosea](https://distrosea.com/fr/) pour tester les diférentes distributions de Linux

Un émulateur Linux : [Linux](https://chinginfo.fr/dossier/weblinux/?user=oW6q1c3reT&cpu=asm&n=1&relayURL=wss%3A%2F%2Frelay.widgetry.org%2F&refresh=okok)

### Différence entre terminal/Shell/ligneDeCommande...

<figure markdown>
<iframe width="560" height="315" src="https://www.youtube.com/embed/8-ZIby5U7LU?si=PdgVXzhIf3GFRxI5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</figure>